...
urlpatterns = [
    ...
    url(r'^monitor/meters/$', SiteViews.meter_list_page, name="Monitor | Meter Overview"),
    url(r'^monitor/alarms/$', SiteViews.alarm_list_page, name="Monitor | Alarms | Alarm Overview"),
    url(r'^alarms/([a-z0-9\-]+)/$', SiteViews.edit_alarm, name="Monitor | Alarms | Edit Alarm"),
